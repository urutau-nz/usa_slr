...
fig, ax = plt.subplots()
# ax2 = ax.twinx()
ax.plot(extr_exp['year'], extr_exp['U7B001'], color='darkred', label='Exposed extreme SLR')
ax.scatter(extr_exp['year'], extr_exp['U7B001'], color='darkred')
ax.plot(high_exp['year'], high_exp['U7B001'], color='firebrick', label='Exposed high SLR')
ax.scatter(high_exp['year'], high_exp['U7B001'], color='firebrick')
ax.plot(inter_exp['year'], inter_exp['U7B001'], color='lightcoral', label='Exposed intermediate SLR')
ax.scatter(inter_exp['year'], inter_exp['U7B001'], color='lightcoral')

ax.plot(extr_iso['year'], extr_iso['U7B001'], color='#1f386b', label='Isolated extreme SLR')
ax.scatter(extr_iso['year'], extr_iso['U7B001'], color='#1f386b')
ax.plot(high_iso['year'], high_iso['U7B001'], color='#627397', label='Isolated high SLR')
ax.scatter(high_iso['year'], high_iso['U7B001'], color='#627397')
ax.plot(inter_iso['year'], inter_iso['U7B001'], color='#a5afc3', label='Isolated intermediate SLR')
